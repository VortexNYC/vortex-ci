/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 1dda1d2d3936a95dbb97098d256a422d)
// Runtime types generated with workerd@1.20260915.1 2026-08-27 nodejs_compat
interface __BaseEnv_Env {
	BACKUP_BUCKET: R2Bucket;
	ARTIFACTS: Artifacts;
	BACKUP_BUCKET_NAME: "vortex-ci-backups";
	CLOUDFLARE_ACCOUNT_ID: "31bfc2c14a28e0a39e8b9e3c556a18be";
	CLOUDFLARE_DEPLOY_ACCOUNT_ID: "31bfc2c14a28e0a39e8b9e3c556a18be";
	SANDBOX: DurableObjectNamespace<import("./index").CiSandbox>;
	CI_WORKFLOW: Workflow<Parameters<import("./index").CI['run']>[0]['payload']>;
}
